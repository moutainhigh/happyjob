...
public class Zz253Request {
    ...
    public String toString() {
        return "Zz253Request [account=" + account + ", password=" + password + ", msg=" + msg + ", phone=" + phone
            + ", sendtime=" + sendtime + ", report=" + report + ", extend=" + extend + ", uid=" + uid + "]";
    }
