...
//            <th>'+ item.title +'</th>\
            ...
            if(item.useOn ==0){
            	templeteTr += '<button type="button" class="btn btn-default btn-sm cat">开启</button>' ;
            }else{
            	templeteTr += '<button type="button" class="btn btn-default btn-sm cat">关闭</button>' ;
            }
            templeteTr  += '\
                <button type="button" class="btn btn-primary btn-sm auth">编辑</button>\
                <button type="button" class="btn btn-danger btn-sm forbidden">删除</button>\
            </th></tr>';
